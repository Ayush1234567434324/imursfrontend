...
export const DashboardHome = (props)=>{
    ...
    return(
        <Dashboard data={props.data}>
            ...
            <div className="body">
            <Banner heading="Cherised Daily" sub_heading="Lighter then albums, heavier in memories." url="banner/_0ba14457-5bc1-409f-a1e2-3e5fb234a151-Color-Restored-Enhanced.jpg" but={true}/>
            ...
            <Banner heading="Beyond Images" sub_heading="Turn images into timeless decor art" url="banner/Untitled design - 3 (1).jpg" but={true}/>
